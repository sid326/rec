		...
		if(isset($_SESSION[$temp3]))
{
	...
	else if($_GET['domain']=="graphicdesigning")
	{
		$temp="gd";
		$temp3="nologin".$temp;
		if(isset($_SESSION[$temp3]))
...
var property = document.getElementById(divID1);
      
    
    
        property.style.border= "5px solid pink"
...
{
	window.location="http://localhost/home/review.php";
}
}
...
$db = new dbConnect();
 $sql="select max(id) as max from `{$temp}`";
